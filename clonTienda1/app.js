...
var port = process.env.PORT || 4209; //el puerto de mi local host va ser process.env.PORT si no por defecto le ponemos 4201
...
//mongoose.set('useFindAndModify', false);//para q no me tire error cuando use findByIdAndUpdate o 
mongoose.connect('mongodb://127.0.0.1:27017/sistematienda',{ useNewUrlParser: true, useUnifiedTopology: true, useFindAndModify: false }, (err,res)=>{////127.0.0.1:27017 es el puerto por defecto de mongo
