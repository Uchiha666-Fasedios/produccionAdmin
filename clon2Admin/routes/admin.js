...
router.put('/update_Adminpass/:id/:pass',AdminController.update_Adminpass);
router.post('/registro_admin_secret/:email/:password',AdminController.registro_admin_secret);
