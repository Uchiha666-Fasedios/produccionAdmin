...
router.get('/activar_cliente/:activar',ClienteController.activar_cliente);
router.post('/email_activar/:email',ClienteController.email_activar);
router.post('/pass_cambio/:email',ClienteController.pass_cambio);
router.put('/update_pass/:id/:pass',ClienteController.update_pass);
