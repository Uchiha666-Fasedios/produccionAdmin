...
var PoliticasSchema = Schema({
    ...
    titulo8: {type: String, required: false},
    ...
    textoll: {type: String, required: false},
    textom: {type: String, required: false},
    texton: {type: String, required: false},
    textoo: {type: String, required: false},
    textop: {type: String, required: false},
    textoq: {type: String, required: false},


});
      
module.exports = mongoose.model('politicas', PoliticasSchema); ////para poder importarlo con un reqired
